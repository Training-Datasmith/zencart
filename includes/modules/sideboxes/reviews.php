...
$random_review_sidebox_product = $db->execute_random_multi($random_review_sidebox_select, MAX_RANDOM_SELECT_REVIEWS);
if ($random_review_sidebox_product->record_count() > 0) {
