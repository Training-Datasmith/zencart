...
if ($show_specials == true) {
    ...
    $random_specials_sidebox_product = $db->execute_random_multi($random_specials_sidebox_product_query, MAX_RANDOM_SELECT_SPECIALS);
    if ($random_specials_sidebox_product->record_count() > 0) {
