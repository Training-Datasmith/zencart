...
$random_whats_new_sidebox_product = $db->execute_random_multi($random_whats_new_sidebox_product_query, MAX_RANDOM_SELECT_NEW);
if ($random_whats_new_sidebox_product->record_count() > 0) {
