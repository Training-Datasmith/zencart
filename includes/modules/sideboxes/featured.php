...
$random_featured_product = $db->execute_random_multi($random_featured_products_query, MAX_RANDOM_SELECT_FEATURED_PRODUCTS);
if ($random_featured_product->record_count() > 0) {
