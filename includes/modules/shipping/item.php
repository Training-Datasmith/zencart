 ...
 * @since ZC v1.0.3
 */
class item extends Zen_Shipping
{
    ...
    public function update_status(): void
    {
        ...
        $this->check_enabled_for_zone(MODULE_SHIPPING_ITEM_ZONE);
        if ($this->enabled) {
            // -----
    ...
    public function quote($method = ''): array
    {
        ...
        $this->quotes = ['id' => $this->code, 'module' => MODULE_SHIPPING_ITEM_TEXT_TITLE, 'methods' => [['id' => $this->code, 'title' => MODULE_SHIPPING_ITEM_TEXT_WAY, 'cost' => MODULE_SHIPPING_ITEM_COST * $item_total_count + MODULE_SHIPPING_ITEM_HANDLING]]];
        if ($this->tax_class > 0) {
