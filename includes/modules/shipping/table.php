 ...
 * @since ZC v1.0.3
 */
class table extends Zen_Shipping
{
    /**
     * constructor
     *
    ...
    public function update_status(): void
    {
        ...
        $this->check_enabled_for_zone(MODULE_SHIPPING_TABLE_ZONE);
        if ($this->enabled) {
            // -----
    ...
    public function quote($method = ''): array
    {
        ...
        $this->quotes = ['id' => $this->code, 'module' => MODULE_SHIPPING_TABLE_TEXT_TITLE . $show_box_weight, 'methods' => [['id' => $this->code, 'title' => MODULE_SHIPPING_TABLE_TEXT_WAY, 'cost' => $shipping + (MODULE_SHIPPING_TABLE_HANDLING_METHOD === 'Box' ? MODULE_SHIPPING_TABLE_HANDLING * $shipping_num_boxes : MODULE_SHIPPING_TABLE_HANDLING)]]];
        if ($this->tax_class > 0) {
