 ...
 * @since ZC v1.0.3
 */
class zones extends Zen_Shipping
{
    /**
    ...
    public function quote($method = ''): array
    {
        ...
        $this->quotes = ['id' => $this->code, 'module' => MODULE_SHIPPING_ZONES_TEXT_TITLE, 'methods' => [['id' => $this->code, 'title' => $shipping_method, 'cost' => $shipping_cost]]];
