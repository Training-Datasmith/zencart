 ...
 * @since ZC v1.3.0
 */
class freeoptions extends Zen_Shipping
{
     ...
     * @since ZC v1.5.8
     */
    protected function check_for_free_options()
    {
        global $order;
        // -----
    ...
    public function quote($method = ''): array
    {
        ...
        // module is enabled!
        //
        $this->quotes = ['id' => $this->code, 'module' => MODULE_SHIPPING_FREEOPTIONS_TEXT_TITLE, 'methods' => [['id' => $this->code, 'title' => MODULE_SHIPPING_FREEOPTIONS_TEXT_WAY, 'cost' => (float) MODULE_SHIPPING_FREEOPTIONS_COST + (float) MODULE_SHIPPING_FREEOPTIONS_HANDLING]]];
        if ($this->tax_class > '0') {
