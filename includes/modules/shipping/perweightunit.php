 ...
 * @since ZC v1.3.0
 */
class perweightunit extends Zen_Shipping
{
    /**
     * Constructor
     *
    ...
    public function update_status(): void
    {
        ...
        $this->check_enabled_for_zone(MODULE_SHIPPING_PERWEIGHTUNIT_ZONE);
        if ($this->enabled) {
            // -----
    ...
    public function quote($method = ''): array
    {
        ...
        $this->quotes = ['id' => $this->code, 'module' => MODULE_SHIPPING_PERWEIGHTUNIT_TEXT_TITLE, 'methods' => [['id' => $this->code, 'title' => MODULE_SHIPPING_PERWEIGHTUNIT_TEXT_WAY, 'cost' => (float) MODULE_SHIPPING_PERWEIGHTUNIT_COST * ($total_weight_units * $shipping_num_boxes) + (MODULE_SHIPPING_PERWEIGHTUNIT_HANDLING_METHOD == 'Box' ? (float) MODULE_SHIPPING_PERWEIGHTUNIT_HANDLING * $shipping_num_boxes : (float) MODULE_SHIPPING_PERWEIGHTUNIT_HANDLING)]]];
        if ($this->tax_class > 0) {
