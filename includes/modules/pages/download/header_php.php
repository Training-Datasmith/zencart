...
$zco_notifier->notify('NOTIFY_DOWNLOAD_BROWSER_DETECTION', [], $detectedBrowser, $_SERVER['HTTP_USER_AGENT'], $version, $browser_headers_override, $browser_extra_headers);
...
$zco_notifier->notify('NOTIFY_DOWNLOAD_READY_TO_STREAM', [], $service, $origin_filename, $browser_filename, $source_directory, $downloadFilesize);
