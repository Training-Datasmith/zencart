...
if (isset($_POST['action']) && (($_POST['action'] == 'process') || ($_POST['action'] == 'update'))) {
    ...
    if ($error == false) {
        $sql_data_array = [['fieldName' => 'entry_firstname', 'value' => $firstname, 'type' => 'stringIgnoreNull'],
        ...
        if ($_POST['action'] == 'update') {
            ...
            if ((isset($_POST['primary']) && ($_POST['primary'] == 'on')) || ($_GET['edit'] == $_SESSION['customer_default_address_id'])) {
                ...
                $sql_data_array = [['fieldName' => 'customers_firstname', 'value' => $firstname, 'type' => 'stringIgnoreNull'],
                                        ['fieldName' => 'customers_lastname', 'value' => $lastname, 'type' => 'stringIgnoreNull'],
                                        ['fieldName' => 'customers_default_address_id', 'value' => $_GET['edit'], 'type' => 'integer']];
