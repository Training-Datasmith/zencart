...
if (!isset($product_info) || $product_info::class !== 'Product' || $product_info->get_id() !== (int) $_GET['products_id']) {
...
if ($product_not_found) {
    ...
    $product_data = $product_info->get_data_for_language();
    ...
    $flag_show_product_info_starting_at = 0;
    // zen_get_show_product_switch($_GET['products_id'], 'starting_at');
    $flag_show_product_info_model = 0;
    // zen_get_show_product_switch($_GET['products_id'], 'model');
    $flag_show_product_info_weight = 0;
    // zen_get_show_product_switch($_GET['products_id'], 'weight');
    $flag_show_product_info_quantity = 0;
    // zen_get_show_product_switch($_GET['products_id'], 'quantity');
    $flag_show_product_info_manufacturer = 0;
    // zen_get_show_product_switch($_GET['products_id'], 'manufacturer');
    $flag_show_product_info_in_cart_qty = 0;
    // zen_get_show_product_switch($_GET['products_id'], 'in_cart_qty');
