...
$sub_heading_text = 'SUB_HEADING_TEXT_' . $gv_faq_item;
$sub_heading_title = 'SUB_HEADING_TITLE_' . $gv_faq_item;
if (!defined($sub_heading_text)) {
    $sub_heading_text = 'SUB_HEADING_TEXT_0';
}
if (!defined($sub_heading_title)) {
    $sub_heading_title = 'SUB_HEADING_TITLE_0';
}
$sub_heading_text = constant($sub_heading_text);
$sub_heading_title = constant($sub_heading_title);
