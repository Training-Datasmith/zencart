...
if (DISPLAY_CONDITIONS_ON_CHECKOUT == 'true') {
    if (!isset($_POST['conditions']) || $_POST['conditions'] != '1') {
        $message_stack->add_session('checkout_payment', ERROR_CONDITIONS_NOT_ACCEPTED, 'error');
    }
}
...
if ($credit_covers === false && isset(${$_SESSION['payment']}->flag_disable_payment_address_change)) {
