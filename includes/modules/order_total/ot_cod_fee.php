    ...
    public function process(): void
    {
        ...
        if ($this->enabled == true) {
            ...
            if ($cod_country) {
                ...
                $this->output[] = ['title' => $this->title . ':', 'text' => $currencies->format($cod_cost, true, $order->info['currency'], $order->info['currency_value']), 'value' => $cod_cost];
            } else {
