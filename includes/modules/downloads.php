...
if (!defined('TEXT_FILESIZE_KBS')) {
    define('TEXT_FILESIZE_KBS', ' KB');
}
if (!defined('TEXT_FILESIZE_MEGS')) {
    define('TEXT_FILESIZE_MEGS', ' MB');
}
if (!defined('TEXT_FILESIZE_UNKNOWN')) {
    define('TEXT_FILESIZE_UNKNOWN', 'Unknown');
}
$last_order = $_GET['order_id'] ?? 0;
...
$number_of_downloads = count($downloads);
$downloads_not_available_yet = $downloads_on_this_order && $number_of_downloads < 1;