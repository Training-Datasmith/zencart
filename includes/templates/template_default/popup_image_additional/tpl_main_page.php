...
// $products_values->fields['products_image']
  if (file_exists(basename($_GET['products_image_large_additional']))) {
      echo '<a href="javascript:window.close()">' . zen_image(basename($_GET['products_image_large_additional']), (isset($products_values->fields['products_name']) ? $products_values->fields['products_name'] . ' ' : '') . TEXT_CLOSE_WINDOW_IMAGE) . '</a>';
  } else {
