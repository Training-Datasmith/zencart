...
<h1 id="addressBookDefaultHeading"><?php 
echo HEADING_TITLE;
?></h1>
...
<h2 id="addressBookDefaultPrimary"><?php 
...
<?php 
if (count($address_array) < MAX_ADDRESS_BOOK_ENTRIES) {
    ?>
   <div class="buttonRow forward"><?php 
    echo '<a href="' . zen_href_link(FILENAME_ADDRESS_BOOK_PROCESS, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_ADD_ADDRESS, BUTTON_ADD_ADDRESS_ALT) . '</a>';
    ?></div>
<?php 
}
?>
