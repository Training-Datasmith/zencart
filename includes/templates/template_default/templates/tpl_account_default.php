...
if (!empty($orders_array)) {
    ?>
<p class="forward"><?php 
    echo '<a href="' . zen_href_link(FILENAME_ACCOUNT_HISTORY, '', 'SSL') . '">' . OVERVIEW_SHOW_ALL_ORDERS . '</a>';
    ?></p>
<br class="clearBoth">
...
<?php 
  ...
  <tr>
    ...
    <td class="accountOrderId"><?php 
        ...
        ?></td>
    <td class="accountAddress"><address><?php 
    ...
    <td class="accountOrderTotal alignRight"><?php 
        ...
        ?></td>
    <td class="accountOrderViewButton alignRight"><?php 
