...
<h1 id="checkoutShipAddressDefaultHeading"><?php 
echo HEADING_TITLE;
?></h1>
...
<h2 id="checkoutShipAddressDefaultAddress"><?php 
...
if ($process == true) {
    ?>
  <div class="buttonRow back"><?php 
    echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '">' . zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT) . '</a>';
    ?></div>
