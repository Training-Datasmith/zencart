...
if ($reviews_split->number_of_rows > 0) {
    if (PREV_NEXT_BAR_LOCATION == '1' || PREV_NEXT_BAR_LOCATION == '3') {
        ?>
<div id="reviewsDefaultListingTopNumber" class="navSplitPagesResult"><?php 
        echo $reviews_split->display_count(TEXT_DISPLAY_NUMBER_OF_REVIEWS);
        ?></div>

<div id="reviewsDefaultListingTopLinks" class="navSplitPagesLinks"><?php 
...
if ($reviews_split->number_of_rows > 0 && (PREV_NEXT_BAR_LOCATION == '2' || PREV_NEXT_BAR_LOCATION == '3')) {
    ?>
<hr>
<div id="reviewsDefaultListingBottomNumber" class="navSplitPagesResult"><?php 
    echo $reviews_split->display_count(TEXT_DISPLAY_NUMBER_OF_REVIEWS);
    ?></div>

<div id="reviewsDefaultListingBottomLinks" class="navSplitPagesLinks"><?php 
    echo TEXT_RESULT_PAGE . $reviews_split->display_links($max_display_page_links, zen_get_all_get_params(['page', 'info', 'main_page']), $paginate_as_ul);
    ?></div>
<br class="clearBoth">
<?php 
