...
if (CONTACT_US_STORE_NAME_ADDRESS == '1') {
    ?>
<address><?php 
    echo nl2br(STORE_NAME_ADDRESS, false);
    ?></address>
<?php 
}
?>
...
<label class="inputLabel" for="send-to"><?php 
        ...
        ?></label>
<?php 
        echo zen_draw_pull_down_menu('send_to', $send_to_array, $send_to_default, 'id="send-to" required size="' . count($send_to_array) . '"') . '<span class="alert">' . ENTRY_REQUIRED_SYMBOL . '</span>';
        ?>
<br class="clearBoth">
<?php 
    }
...
<label class="inputLabel" for="telephone"><?php 
    ...
    ?></label>
<?php 
    echo zen_draw_input_field('telephone', $telephone, ' size="20" id="telephone" autocomplete="off"', 'tel');
    ?>
<br class="clearBoth">
