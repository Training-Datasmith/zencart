...
<div id="reviewsInfoDefaultProductPageLink" class="buttonRow"><?php echo '<a href="' . zen_href_link(zen_get_info_page($_GET['products_id']), zen_get_all_get_params(['reviews_id'])) . '">' . zen_image_button(BUTTON_IMAGE_GOTO_PROD_DETAILS, BUTTON_GOTO_PROD_DETAILS_ALT) . '</a>'; ?></div>

<div id="reviewsInfoDefaultReviewsListingLink" class="buttonRow"><?php echo($reviews_counter > 1 ? '<a href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS, zen_get_all_get_params(['reviews_id'])) . '">' . zen_image_button(BUTTON_IMAGE_MORE_REVIEWS, BUTTON_MORE_REVIEWS_ALT) . '</a>' : ''); ?></div>

<div class="buttonRow"><?php echo '<a href="' . zen_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, zen_get_all_get_params(['reviews_id'])) . '">' . zen_image_button(BUTTON_IMAGE_WRITE_REVIEW, BUTTON_WRITE_REVIEW_ALT) . '</a>'; ?></div>
</div>
...
<div id="reviewsInfoDefaultMainContent" class="content"><?php echo nl2br(zen_output_string_protected(stripslashes((string) $review_info->fields['reviews_text']))); ?></div>
