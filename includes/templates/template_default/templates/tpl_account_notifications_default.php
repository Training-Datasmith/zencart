...
<?php 
echo zen_draw_form('account_notifications', zen_href_link(FILENAME_ACCOUNT_NOTIFICATIONS, '', 'SSL')) . zen_draw_hidden_field('action', 'process');
?>

<h1 id="accountNotificationsHeading"><?php 
echo HEADING_TITLE;
?></h1>

<div class="notice"><?php 
echo MY_NOTIFICATIONS_DESCRIPTION;
?></div>

<fieldset>
<legend><?php 
echo GLOBAL_NOTIFICATIONS_TITLE;
?></legend>

<?php 
echo zen_draw_checkbox_field('product_global', '1', $global->fields['global_product_notifications'] == '1' ? true : false, 'id="globalnotify"');
?>
<label class="checkboxLabel" for="globalnotify"><?php 
