...
if (CUSTOMERS_APPROVAL === '3' && TEXT_LOGIN_FOR_PRICE_BUTTON_REPLACE_SHOWROOM == '') {
    ...
    if ($products_qty_box_status == 0 || $products_quantity_order_max == 1) {
        ...
        $the_button = zen_draw_hidden_field('cart_quantity', '1') . zen_draw_hidden_field('products_id', (int) $_GET['products_id']) . zen_image_submit(BUTTON_IMAGE_IN_CART, BUTTON_IN_CART_ALT);
    } else {
...
<!-- bof Ask a Question -->
    ...
    <span id="productQuestions" class="biggerText">
        <b><a href="<?php 
    echo zen_href_link(FILENAME_ASK_A_QUESTION, 'pID=' . $_GET['products_id'], 'SSL');
    ?>">
            <?php 
    echo ASK_A_QUESTION;
    ?>
