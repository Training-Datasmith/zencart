...
<?php 
if (defined('ROBOTS_PAGES_TO_SKIP') && in_array($current_page_base, explode(',', constant('ROBOTS_PAGES_TO_SKIP'))) || $current_page_base == 'down_for_maintenance' || $robots_no_index === true) {
    ?>
...
?>
  ...
  <base href="<?php 
echo $request_type == 'SSL' ? HTTPS_SERVER . DIR_WS_HTTPS_CATALOG : HTTP_SERVER . DIR_WS_CATALOG;
?>">
<?php 
...
<?php 
if (file_exists(DIR_WS_TEMPLATE . 'jscript/jquery.min.js')) {
    ?>
<script title="jQuery check - template">window.jQuery || document.write('<script src="<?php 
    echo $template->get_template_dir('.js', DIR_WS_TEMPLATE, $current_page_base, 'jscript');
    ?>/jquery.min.js"><\/script>');</script>
<?php 
}
?>
<script title="jQuery check - template_default">window.jQuery || document.write('<script src="<?php 
echo $template->get_template_dir('.js', 'template_default', $current_page_base, 'jscript');
?>/jquery.min.js"><\/script>');</script>
...
?>
  ...
  <?php 
if (empty($disable_font_awesome_v4compatibility)) {
    ?>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/v4-shims.css" integrity="sha256-CB2v9WYYUz97XoXZ4htbPxCe33AezlF5MY8ufd1eyQ8= sha384-JfB3EVqS5xkU+PfLClXRAMlOqJdNIb2TNb98chdDBiv5yD7wkdhdjCi6I2RIZ+mL sha512-tqGH6Vq3kFB19sE6vx9P6Fm/f9jWoajQ05sFTf0hr3gwpfSGRXJe4D7BdzSGCEj7J1IB1MvkUf3V/xWR25+zvw==" crossorigin="anonymous">
  <?php 
}
// ZCAdditions.com, ZCA Responsive Template Default (EOF-addition 2 of 2)
