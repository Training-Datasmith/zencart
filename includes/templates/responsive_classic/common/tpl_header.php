...
if ($message_stack->size('header') > 0) {
    echo $message_stack->output('header');
}
...
<div id="navMain">
  <ul>
    ...
    ?><i class="fa-solid fa-house" title="Home"></i></a></li>
...
<?php 
    ...
    <li><a href="<?php 
        ...
        ?>"><i class="fa-solid fa-arrow-right-from-bracket" title="Log Off"></i></a></li>
<?php 
        if ($_SESSION['cart']->count_contents() != 0) {
            ?>
    <li><a href="<?php 
            echo zen_href_link(FILENAME_ACCOUNT, '', 'SSL');
            ?>"><i class="fa-solid fa-user" title="My Account"></i></a></li>
<?php 
        } else {
            ?>
...
<?php 
    ...
    <li><a href="<?php 
            ...
            ?>"><i class="fa-solid fa-arrow-right-to-bracket" title="Log In"></i></a></li>
<?php 
        } else {
            ?>
    <li class="last"><a href="<?php 
...
<?php 
    if ($_SESSION['cart']->count_contents() != 0) {
        ?>
    <li><a class="navCartContentsIndicator" href="<?php 
        echo zen_href_link(FILENAME_SHOPPING_CART, '', 'NONSSL');
        ?>"><i class="fa-solid fa-cart-shopping" title="Shopping Cart"></i></a></li>
    <li class="last"><a href="<?php 
        echo zen_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL');
        ?>"><i class="fa-solid fa-square-check" title="Checkout"></i></a></li>
<?php 
    }
    ?>
  </ul>
...
<?php 
    if ($_SESSION['cart']->count_contents() != 0) {
        ?>
    <li>
      <a class="navCartContentsIndicator" href="<?php 
        echo zen_href_link(FILENAME_SHOPPING_CART, '', 'NONSSL');
        ?>"><i class="fa-solid fa-cart-shopping" title="Shopping Cart"></i>
     <?php 
        echo HEADER_TITLE_CART_CONTENTS;
...
<?php 
    ...
    if (SHOW_BANNERS_GROUP_SET2 != '' && $banner = zen_banner_exists('dynamic', SHOW_BANNERS_GROUP_SET2)) {
        if ($banner->record_count() > 0) {
            ?>
  <div id="bannerTwo" class="banners"><?php 
...
<?php 
if (EZPAGES_STATUS_HEADER == '1' or EZPAGES_STATUS_HEADER == '2' && zen_is_whitelisted_admin_ip()) {
