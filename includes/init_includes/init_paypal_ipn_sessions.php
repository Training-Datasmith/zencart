...
$session_stuff = explode('=', (string) $session_post);
$ipn_found_session = true;
if (!$is_e_ctransaction && !isset($_POST['parent_txn_id']) && ipn_get_stored_session($session_stuff) === false) {
