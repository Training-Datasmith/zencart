...
final class Path implements IteratorAggregate
{
     ...
     */
    public function elliptic_arc(float $x_radius, float $y_radius, float $x_axis_rotation, bool $large_arc, bool $sweep, float $x, float $y): self
    {
        $path = clone $this;
        $path->operations[] = new Elliptic_Arc($x_radius, $y_radius, $x_axis_rotation, $large_arc, $sweep, $x, $y);
        return $path;
    }
    /**
