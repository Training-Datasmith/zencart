 ...
 * @since ZC v2.0.0
 */
class Measurement_Units
{
    /**
     * Convert weight from one unit to another
     * @since ZC v2.0.0
     */
    public static function convert_weight(float|int $incoming, string $from_unit, string $to_unit, ?int $precision = null): float|int
    {
        ...
        $ratio['oz']['lbs'] = 0.0625;
        $ratio['oz']['kgs'] = 0.02834952;
        //0.0625 * 0.45359237;
        $ratio['oz']['g'] = 28.34952;
        //0.0625 * 0.45359237 * 1000;
        $ratio['kgs']['oz'] = 35.2739619;
        //2.20462262 * 16;
        $ratio['kgs']['lbs'] = 2.20462262;
        $ratio['kgs']['g'] = 1000;
        $ratio['g']['oz'] = 0.0352739619;
        //0.001 * 2.20462262 * 16;
        $ratio['g']['kgs'] = 0.001;
        $ratio['g']['lbs'] = 0.00220462262;
     ...
     * @since ZC v2.0.0
     */
    public static function convert_length(float|int $incoming, string $from_unit, string $to_unit, ?int $precision = null): float
    {
