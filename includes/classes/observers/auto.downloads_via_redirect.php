...
class zcObserverDownloadsViaRedirect extends base
{
     ...
     */
    private readonly string $wsPubFolder;
     ...
     * @since ZC v1.5.6
     */
    protected function updateNotifyDownloadReadyToRedirect(&$class, $eventID, $array, &$service, string &$origin_filename, &$browser_filename, string &$source_directory, &$link_create_status)
    {
        ...
        umask(0000);
        mkdir($this->pubFolder . $tempdir, octdec((string) DOWNLOAD_CHMOD));
     ...
     * @since ZC v1.5.6
     */
    private function garbageCollectionUnlinkTempFolders(string $dir): void
    {
        $h1 = opendir($dir);
