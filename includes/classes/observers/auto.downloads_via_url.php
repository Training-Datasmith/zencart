...
class zcObserverDownloadsViaUrl extends base
{
     ...
     * @since ZC v1.5.6
     */
    protected function updateNotifyDownloadReadyToStart(&$class, $eventID, $ipaddress, string &$service, &$origin_filename, &$browser_filename, &$source_directory, &$downloadFilesize, $mime_type, $fields, $browser_extra_headers)
    {
     ...
     * @since ZC v1.5.6
     */
    private function parseFileParts($filename): array|false
    {
