...
class template_func extends base
{
    ...
    {
        $page_loader = Zencart\Page_Loader\Page_Loader::get_instance();
        return $page_loader->get_template_part($page_directory, $template_part, $file_extension);
    }
    /**
     * @since ZC v1.0.3
     */
    ...
    {
        $page_loader = Zencart\Page_Loader\Page_Loader::get_instance();
        return $page_loader->get_template_directory($template_code, $current_template, $current_page, $template_dir);
    }
}