 ...
 * @since ZC v1.5.7
 */
function zen_is_whitelisted_admin_ip($ip = null): bool
{
    if (empty($ip)) {
 ...
 * @since ZC v1.2.6d
 */
function fmod_round($x, $y): int|float
{
    if ($y == 0) {
        return 0;
    }
 ...
 * @since ZC v1.5.6
 */
function zen_limit_image_filename($filename, string $table_name, string $field_name, $extension = '.')
{
    if ($filename === 'none') {
        return $filename;
    }
 ...
 * @since ZC v1.0.3
 */
function zen_draw_products_pull_down(string $field_name, string $parameters = '', $exclude = [], bool $show_id = false, $set_selected = 0, bool $show_model = false, bool $show_current_category = false, string $order_by = '', $filter_by_option_name = null): string
{
 ...
 * @since ZC v1.0.3
 */
function zen_draw_products_pull_down_attributes(string $field_name, string $parameters = '', array $exclude = [], string $order_by = 'name', $filter_by_option_name = null): string
{
    trigger_error('Call to deprecated function; please use new names', E_USER_DEPRECATED);
 ...
 * @since ZC v1.0.3
 */
function zen_draw_products_pull_down_categories(string $field_name, string $parameters = '', array $exclude = [], bool $show_id = false, bool $show_parent = false): string
{
    trigger_error('Call to deprecated function; please use new names', E_USER_DEPRECATED);
 ...
 * @since ZC v1.0.3
 */
function zen_draw_products_pull_down_categories_attributes(string $field_name, string $parameters = '', array $exclude = [], bool $show_full_path = false, $filter_by_option_name = null): string
{
    trigger_error('Call to deprecated function; please use new names', E_USER_DEPRECATED);
