 ...
 * @since ZC v1.3.0
 */
function zen_ez_pages_link($ez_pages_id, $ez_pages_chapter = 0, $ez_pages_is_ssl = true, $ez_pages_open_new_window = false, $ez_pages_return_full_url = false): string
{
    global $db;
    $ez_link = 'unknown';
    ...
    if ($ez_pages_chapter == 0) {
        ...
        switch (true) {
            ...
            case ($ez_pages_alturl != '' and $ez_pages_open_new_window == '0'):
                $ez_pages_linkto  = (str_starts_with((string) $ez_pages_alturl, 'http')) ?
                                    $ez_pages_alturl :
