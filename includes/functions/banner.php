 ...
 * @since ZC v1.0.3
 */
function zen_display_banner($action = '', ?string $identifier = '')
{
 ...
 * @since ZC v1.0.3
 */
function zen_update_banner_display_count($banner_id): void
{
    global $db;
 ...
 * @since ZC v1.0.3
 */
function zen_update_banner_click_count($banner_id): void
{
    global $db;
 ...
 * @since ZC v1.2.0d
 */
function zen_build_banners_group($selected_banners): string
{
    global $db;
