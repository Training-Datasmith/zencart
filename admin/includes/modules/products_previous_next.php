...
$curr_page = match (true) {
    strstr((string) $PHP_SELF, FILENAME_ATTRIBUTES_CONTROLLER) => FILENAME_ATTRIBUTES_CONTROLLER,
    strstr((string) $PHP_SELF, FILENAME_PRODUCTS_TO_CATEGORIES) => FILENAME_PRODUCTS_TO_CATEGORIES,
    default => FILENAME_PRODUCTS_PRICE_MANAGER,
};
