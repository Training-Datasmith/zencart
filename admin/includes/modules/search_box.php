...
?>
<?php echo zen_draw_form('searchForm', basename((string) $PHP_SELF, '.php'), '', 'get'); ?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <div class="input-group">
        ...
        <span class="input-group-btn">
          <a href="<?php echo zen_href_link(basename((string) $PHP_SELF, '.php')); ?>" class="btn btn-default" role="button" title="<?php echo IMAGE_RESET; ?>"><i class="fa-solid fa-xmark fa-lg"></i></a>
        </span>
      </div>
    </div>
  </div>
        ...
        <div class="row">
            <div class="form-horizontal col-xs-6">
                <div class="form-group" id="searchRestrictIds">
                    ...
                    <?= zen_draw_checkbox_field('restrictIDs', '', (!empty($_GET['restrictIDs']) && $_GET['restrictIDs'] === 'on'), ''); ?>
                </div>
            </div>
            <div class="form-horizontal col-xs-6">
                <div class="form-group" id="searchTermRepopulate">
                    ...
                    <?= zen_draw_checkbox_field('repopulateSearch', '', (!empty($_GET['repopulateSearch']) && $_GET['repopulateSearch'] === 'on'), ''); ?>
                </div>
            </div>
        </div>
        <?php
