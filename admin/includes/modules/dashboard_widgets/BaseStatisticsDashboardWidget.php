...
if ($result->RecordCount()) {
    ...
    $counter_startdate_formatted = $zcDate->output(DATE_FORMAT_SHORT, mktime(0, 0, 0, (int)substr((string) $counter_startdate, 4, 2), (int)substr((string) $counter_startdate, -2), (int)substr((string) $counter_startdate, 0, 4)));
}
?>
