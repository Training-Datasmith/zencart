...
class newsletter
{
   ...
   */
    ...
    {
        $choose_audience_string = zen_draw_form('audience', FILENAME_NEWSLETTERS, 'page=' . $_GET['page'] . '&nID=' . $_GET['nID'] . '&action=confirm', 'post') . PHP_EOL;
    ...
    public function confirm(): string
    {
        ...
        return $confirm_string . ('</form>' . PHP_EOL);
    }
