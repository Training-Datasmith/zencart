...
$contents = ['form' => zen_draw_form('products', FILENAME_CATEGORY_PRODUCT_LISTING, 'action=move_product_confirm&cPath=' . $current_category_id . (isset($_GET['page']) ? '&page=' . $_GET['page'] : ''), 'post') . zen_draw_hidden_field('products_id', $pInfo->products_id)];
