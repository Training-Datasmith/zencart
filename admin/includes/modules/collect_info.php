...
<div class="well product-images-area">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-md-9 col-lg-6">
            <?php echo zen_draw_file_field('products_image', ''); ?>
...
?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6 col-md-4">
    <?php echo zen_draw_checkbox_field('product_ships_in_own_box', '1', $pInfo->product_ships_in_own_box, '') . '&nbsp;' . TEXT_PRODUCT_SHIPS_IN_OWN_BOX_HELP . '&nbsp;' ?>
    </div>
  </div>
  </div>
  <div class="form-group">
