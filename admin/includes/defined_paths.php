 ...
 * @since ZC v1.5.3
 */
function zen_parse_url($url, $element = 'array'): string|array
{
...
if (!defined('DIR_WS_ADMIN')) {
    define('DIR_WS_ADMIN', preg_replace('#^' . str_replace('-', '\-', zen_parse_url(HTTP_SERVER, '/path')) . '#', '', dirname((string) $_SERVER['SCRIPT_NAME'])) . '/');
}
...
if (!defined('ENABLE_SSL_ADMIN')) {
    define('ENABLE_SSL_ADMIN', str_starts_with(HTTP_SERVER, 'https:') ? 'true' : 'false');
}
