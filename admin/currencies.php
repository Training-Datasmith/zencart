...
switch ($action) {
    case 'new':
        ...
        $contents = ['form' => zen_draw_form('currencies', FILENAME_CURRENCIES, 'page=' . $_GET['page'] . (isset($cInfo) ? '&cID=' . $cInfo->currencies_id : '') . '&action=insert', 'post')];
    ...
    case 'edit':
        ...
        $contents = ['form' => zen_draw_form('currencies', FILENAME_CURRENCIES, 'page=' . $_GET['page'] . '&cID=' . $cInfo->currencies_id . '&action=save', 'post')];
        $contents[] = ['text' => TEXT_INFO_EDIT_INTRO];
        $contents[] = ['text' => '<br>' . zen_draw_label(TEXT_INFO_CURRENCY_TITLE, 'title', 'class="control-label"') . zen_draw_input_field('title', htmlspecialchars((string) $cInfo->title, ENT_COMPAT, CHARSET, true), zen_set_field_length(TABLE_CURRENCIES, 'title', '32') . ' class="form-control"')];
        $contents[] = ['text' => '<br>' . zen_draw_label(TEXT_INFO_CURRENCY_CODE, 'code', 'class="control-label"') . zen_draw_input_field('code', htmlspecialchars((string) $cInfo->code, ENT_COMPAT, CHARSET, true), zen_set_field_length(TABLE_CURRENCIES, 'code', '3') . ' class="form-control"')];
        $contents[] = ['text' => '<br>' . zen_draw_label(TEXT_INFO_CURRENCY_SYMBOL_LEFT, 'symbol_left', 'class="control-label"') . zen_draw_input_field('symbol_left', htmlspecialchars((string) $cInfo->symbol_left, ENT_COMPAT, CHARSET, true), zen_set_field_length(TABLE_CURRENCIES, 'symbol_left', '32') . ' class="form-control"')];
        $contents[] = ['text' => '<br>' . zen_draw_label(TEXT_INFO_CURRENCY_SYMBOL_RIGHT, 'symbol_right', 'class="control-label"') . zen_draw_input_field('symbol_right', htmlspecialchars((string) $cInfo->symbol_right, ENT_COMPAT, CHARSET, true), zen_set_field_length(TABLE_CURRENCIES, 'symbol_right', '32') . ' class="form-control"')];
        $contents[] = ['text' => '<br>' . zen_draw_label(TEXT_INFO_CURRENCY_DECIMAL_POINT, 'decimal_point', 'class="control-label"') . zen_draw_input_field('decimal_point', htmlspecialchars((string) $cInfo->decimal_point, ENT_COMPAT, CHARSET, true), zen_set_field_length(TABLE_CURRENCIES, 'decimal_point', '1') . ' class="form-control"')];
        $contents[] = ['text' => '<br>' . zen_draw_label(TEXT_INFO_CURRENCY_THOUSANDS_POINT, 'thousands_point', 'class="control-label"') . zen_draw_input_field('thousands_point', htmlspecialchars((string) $cInfo->thousands_point, ENT_COMPAT, CHARSET, true), zen_set_field_length(TABLE_CURRENCIES, 'thousands_point', '1') . ' class="form-control"')];
...
?>
    ...
    <div class="row">
        <table class="table">
            <tr>
                <td><?php echo $currency_split->display_count($currency_query_numrows); ?></td>
