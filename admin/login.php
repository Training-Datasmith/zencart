        ...
        <div class="col-sm-offset-1 col-md-offset-3 col-lg-offset-4 col-xs-12 col-sm-10 col-md-6 col-lg-4 text-center">
          <div class="login-main-div login-box-shadow">
            ...
            <?php if (!isset($expired) || $expired == false) { ?>
              <?php echo zen_draw_form('loginForm', FILENAME_LOGIN, zen_get_all_get_params(), 'post') . PHP_EOL; ?>
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <?php echo zen_draw_password_field('admin_pass', '', false) . PHP_EOL; ?>
                </div>
              </div>
              <div class="form-group">
            ...
            <?php } else { ?>
              <?php echo zen_draw_form('loginForm', FILENAME_LOGIN, '', 'post'); ?>
              ...
              <div class="form-group">
                <?php echo zen_draw_password_field('oldpwd-' . $_SESSION['securityToken'], '', false); ?>
              </div>
              <div class="form-group">
                <?php echo zen_draw_password_field('newpwd-' . $_SESSION['securityToken'], '', false); ?>
              </div>
              <div class="form-group">
                <?php echo zen_draw_password_field('confpwd-' . $_SESSION['securityToken'], '', false); ?>
              </div>
              <div class="form-group">
                <button type="submit" class="btn btn-primary btn-lg"><?php echo TEXT_SUBMIT; ?></button>
              </div>
