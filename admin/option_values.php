    ...
    <div class="container-fluid">
        ...
        if (empty($_GET['options_id'])) {
            ...
            <div id="editOptionName">
                ...
                <?php
                echo zen_draw_form('quick_jump', FILENAME_PRODUCTS_OPTIONS_VALUES, '', 'get');
...
if (empty($_GET['options_id'])) {
    ...
    ?>
        ...
        <div class="row">
            <?php echo zen_draw_form('update_product_attributes', FILENAME_PRODUCTS_OPTIONS_VALUES, 'action=update_product', 'post'); ?>
...
// select from all categories with products with attributes
    ?>
        ...
        <div class="row">
            <?php echo zen_draw_form('update_categories_attributes', FILENAME_PRODUCTS_OPTIONS_VALUES, 'action=update_categories_attributes', 'post'); ?>
...
// select the catalog and update all products with attributes
    ?>
        ...
        <div class="row">
          ...
          <div class="col-sm-2">
              <?php echo zen_draw_form('update_all_sort', FILENAME_PRODUCTS_OPTIONS_VALUES, 'action=update_all_products_attributes_sort_order', 'post') ?>
