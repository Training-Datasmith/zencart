    ...
    switch ($action) {
        ...
        case ('update'):
            ...
            if ($_POST['specials_id'] != '') {
                ...
                if (str_ends_with($specials_price_tax_excl, '%')) {
...
// auto fix bad or missing products master_categories_id
        ...
        <?php if (isset($pInfo->products_id) && $pInfo->products_id != '') { ?>
          ...
          <?php
            ...
            default:
                ?>
              <?php echo zen_draw_form('new_prices', FILENAME_PRODUCTS_PRICE_MANAGER, zen_get_all_get_params(['action', 'info', $_GET['products_filter']]) . 'action=update', 'post'); ?>
              <?php
              ...
              <div class="col-sm-12">
                <div class="well" style="color: #31708f;background-color: #d9edf7;border-color: #bce8f1;;padding: 10px 10px 0 0;">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9 col-md-6">
                      <?php echo zen_draw_input_field('products_price_tax_excl', ($pInfo->products_price ?? ''), 'OnKeyUp="updateTaxIncl()" class="form-control" id="products_price_tax_excl"' . $readonly); ?>
                    </div>
                  </div>
                  <div class="form-group">
                    <?php echo zen_draw_label(TEXT_PRICE_INCL, 'products_price_tax_incl', 'class="col-sm-3 control-label"'); ?>
                    <div class="col-sm-9 col-md-6">
                      <?php echo zen_draw_input_field('products_price_tax_incl', ($pInfo->products_price ?? ''), 'OnKeyUp="updateTaxExcl()" class="form-control" id="products_price_tax_incl"' . $readonly); ?>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-sm-12">
                  <div class="well" style="color: #31708f;background-color: #ebebff;border-color: #bce8f1;;padding: 10px 10px 0 0;">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9 col-md-6">
                        <?php echo zen_draw_input_field('specials_price_tax_excl', ($sInfo->specials_new_products_price ?? ''), 'OnKeyUp="updateSpecialsTaxIncl()" class="form-control" id="specials_price_tax_excl"' . $readonly); ?>
                      </div>
                    </div>
                    <div class="form-group">
                      <?php echo zen_draw_label(TEXT_SPECIALS_SPECIAL_PRICE_INCL, 'specials_price_tax_incl', 'class="col-sm-3 control-label"'); ?>
                      <div class="col-sm-9 col-md-6">
                        <?php echo zen_draw_input_field('specials_price_tax_incl', ($sInfo->specials_new_products_price ?? ''), 'OnKeyUp="updateSpecialsTaxExcl()" class="form-control" id="specials_price_tax_incl"' . $readonly); ?>
                      </div>
                    </div>
                  </div>
                </div>
...
// Specials cannot be added to Gift Vouchers when false
                  ...
                  if ((!str_starts_with((string) $pInfo->products_model, 'GIFT')) || (str_starts_with((string) $pInfo->products_model, 'GIFT') && (defined('MODULE_ORDER_TOTAL_GV_SPECIAL') && MODULE_ORDER_TOTAL_GV_SPECIAL == 'true'))) {
                      ?>
