  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      if ($action == 'new') {
        ...
        <div class="row">
          <?php
            echo zen_draw_form('new_banner', FILENAME_BANNER_MANAGER, (isset($_GET['page']) ? 'page=' . $_GET['page'] . '&' : '') . 'action=' . $form_action, 'post');
          if ($form_action == 'upd') {
...
$abbrev_dir_name = DIR_FS_CATALOG_IMAGES;
          ...
          <div style="border: 1px solid grey; padding: 10px;">
            ...
            <div class="form-group row mt-2">
                ...
                <div class="col-sm-9 col-md-6">
                    <?= zen_draw_file_field('banners_image', '') ?>
                </div>
            </div>
            <div class="form-group row mt-2">
        ...
        <div class="row">
          ...
          foreach ($banners as $banner) {
              ...
              if ((empty($_GET['bID']) || $_GET['bID'] == $banner['banners_id']) && empty($bInfo) && !str_starts_with((string) $action, 'new')) {
              ...
              foreach ($banner_positions as $banner_position) {
                  ...
                  $position_texts = preg_split('/\s?-\s?/', (string) $banner_position['configuration_title']);
        ...
        <div class="row">
          <table class="table">
            <tr>
              <td><?= $banners_split->display_count($banners_query_numrows) ?></td>
