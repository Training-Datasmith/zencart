...
?>
      <?php echo zen_draw_form('new_date', FILENAME_STATS_CUSTOMERS_REFERRALS, '', 'get'); ?>
      ...
      <?php echo '</form>'; ?>
      <?php echo zen_draw_form('search', FILENAME_STATS_CUSTOMERS_REFERRALS, '', 'get'); ?>
...
$date1 = explode('-', (string) $_GET['start_date']);
$m1 = $date1[0];
$d1 = $date1[1];
$y1 = $date1[2];

$date2 = explode('-', (string) $_GET['end_date']);
$m2 = $date2[0];
$d2 = $date2[1];
$y2 = $date2[2];
    ...
    foreach ($customers_orders as $customers_order) {
        ...
        ?>
          ...
          <tr>
            ...
            <td class="main"><a href="<?php echo zen_href_link(FILENAME_ORDERS, zen_get_all_get_params(['oID', 'action']) . 'oID=' . $customers_order['orders_id'] . '&action=edit', 'NONSSL'); ?>" class="btn btn-primary" role="button"><?php echo IMAGE_DETAILS; ?></a></td>
          </tr>
