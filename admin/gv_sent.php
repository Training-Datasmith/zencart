...
foreach ($gv_lists as $gv_list) {
    ...
    if (isset($gInfo) && is_object($gInfo) && $gv_list['coupon_id'] == $gInfo->coupon_id) {
        ?>
                    <tr class="dataTableRowSelected" onclick="document.location.href = '<?php echo zen_href_link('gv_sent.php', zen_get_all_get_params(['gid', 'action']) . 'gid=' . $gInfo->coupon_id . '&action=edit'); ?>'">
                    <?php } else { ?>
                    <tr class="dataTableRow" onclick="document.location.href = '<?php echo zen_href_link('gv_sent.php', zen_get_all_get_params(['gid', 'action']) . 'gid=' . $gv_list['coupon_id']); ?>'">
                    <?php } ?>
