...
if ($action === 'delete_product_option') {
    ...
    if ($options_names->RecordCount() > 1) {
        echo zen_draw_form('option_order_by_form', FILENAME_OPTIONS_NAME_MANAGER, '', 'get'); ?>
            <div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6"><?php echo $options_split->display_count($options_query_numrows); ?></div>
                <div class="col-sm-6 text-right"><?php echo $options_split->display_links($options_query_numrows, MAX_ROW_LISTS_OPTIONS, MAX_DISPLAY_PAGE_LINKS, $currentPage); ?></div>
            </div>
        <?php } ?>
        <table class="table table-striped">
            <thead>
        ...
        foreach ($options_names as $options_name) { // list the Option Names
            ...
            if (($action === 'update_option') && ((int)$_GET['option_id'] === (int)$options_name['products_options_id'])) { ?>
                    ...
                    <tr>
                        <td colspan="7">
                            <?php echo zen_draw_form('option', FILENAME_OPTIONS_NAME_MANAGER, 'action=update_option_name' . ($currentPage !== 0 ? '&page=' . $currentPage . '&' : '') . 'option_order_by=' . $option_order_by, 'post');
                ...
                for ($i = 0, $n = count($languages); $i < $n; $i++) {
                    ...
                    $inputs2 .= zen_draw_pull_down_menu(
                        'products_options_images_style[' . $languages[$i]['id'] . ']',
                        $productsOptionsImagesStyleArray,
                        $option_name->fields['products_options_images_style'],
                        'class="form-control" style="width:100%" id="products_options_images_style[' . $languages[$i]['id'] . ']"'
                    );
                    $inputs2 .= '</div>';
                    $inputs2 .= '</div>';
                    $inputs2 .= '<br>';
    ...
    if ($action !== 'update_option') { // show row for INSERTING a new Option Name. Displayed by default/when no action set/on initial page load?>
        ...
        echo zen_draw_form('options', FILENAME_OPTIONS_NAME_MANAGER, 'action=add_product_options' . ($currentPage !== 0 ? '&page=' . $currentPage . '&' : '') . 'option_order_by=' . $option_order_by, 'post');
        ?>
        ...
        <div>
            ...
            <div style="border: 1px solid #999;padding:5px">
                ...
                <div>
                    ...
                    <?php echo zen_draw_form('add_values_all_form', FILENAME_OPTIONS_NAME_MANAGER, zen_get_all_get_params(['action', 'update_to', 'update_action']) . '&action=update_options_values&update_to=0&update_action=0', 'post'); ?>
                    <div class="row">
                        <div class="col-sm-3">
                ...
                <div id="addOptionValuesOneWrapper">
                    ...
                    <?php echo zen_draw_form('add_values_one_form', FILENAME_OPTIONS_NAME_MANAGER, zen_get_all_get_params(['action', 'update_to', 'update_action']) . '&action=update_options_values&update_to=1&update_action=0', 'post');
...
if ($selectedOptionId !== '') {
    ...
    echo '<br>' . $products_sort_link;
                ...
                <div id="addOptionValuesCategoryWrapper">
                    ...
                    <?php echo zen_draw_form('add_values_all_category_form', FILENAME_OPTIONS_NAME_MANAGER, zen_get_all_get_params(['action', 'update_to', 'update_action']) . '&action=update_options_values&update_to=2&update_action=0', 'post');
    ...
    echo '<br>' . $show_category_path_link;
            ...
            <div style="border: 1px solid #999;padding:5px">
                ...
                <div>
                    ...
                    <?php echo zen_draw_form('delete_values_all_form', FILENAME_OPTIONS_NAME_MANAGER, zen_get_all_get_params(['action', 'update_to', 'update_action']) . '&action=update_options_values&update_to=0&update_action=1', 'post'); ?>
                    <div class="row">
                        <div class="col-sm-3">
                            <?php
echo zen_draw_label(TEXT_SELECT_OPTION, 'options_id', 'class="control-label"');
echo zen_draw_pull_down_menu('options_id', $optionsValuesArray, '', 'class="form-control" required'); ?>
                ...
                <div id="deleteOptionValuesOneWrapper">
                    ...
                    <?php echo zen_draw_form('delete_values_one_form', FILENAME_OPTIONS_NAME_MANAGER, zen_get_all_get_params(['action', 'update_to', 'update_action']) . '&action=update_options_values&update_to=1&update_action=1', 'post');
...
if ($selectedOptionId !== '') {
    ...
    echo '<br>' . $products_sort_link;
                ...
                <div id="deleteOptionValuesCategoryWrapper">
                    ...
                    <?php echo zen_draw_form('delete_values_category_form', FILENAME_OPTIONS_NAME_MANAGER, zen_get_all_get_params(['action', 'update_to', 'update_action']) . '&action=update_options_values&update_to=2&update_action=1', 'post');
...
if ($selectedOptionId !== '') {
    ...
    echo '<br>' . $show_category_path_link;
            ...
            <div style="border: 1px solid #999;padding:5px">
                ...
                <?php echo zen_draw_form('copy_values_form', FILENAME_OPTIONS_NAME_MANAGER, zen_get_all_get_params(['action']) . '&action=copy_options_values', 'post'); ?>
                <div class="row">
                    <div class="col-sm-3">
