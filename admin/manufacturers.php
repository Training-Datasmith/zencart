...
foreach ($manufacturers as $manufacturer) {
    if ((!isset($_GET['mID']) || (isset($_GET['mID']) && ($_GET['mID'] == $manufacturer['manufacturers_id']))) && !isset($mInfo) && (!str_starts_with((string) $action, 'new'))) {
...
switch ($action) {
    case 'new':
        ...
        $contents = ['form' => zen_draw_form('manufacturers', FILENAME_MANUFACTURERS, 'action=insert', 'post')];
        ...
        $contents[] = ['text' => zen_draw_label(TEXT_MANUFACTURERS_IMAGE, 'manufacturers_image', 'class="control-label"') . zen_draw_file_field('manufacturers_image', '')];
    ...
    case 'edit':
        ...
        $contents = ['form' => zen_draw_form('manufacturers', FILENAME_MANUFACTURERS, ($currentPage != 0 ? 'page=' . $currentPage . '&' : '') . 'mID=' . $mInfo->manufacturers_id . '&action=save', 'post')];
        $contents[] = ['text' => TEXT_INFO_EDIT_INTRO];
        $contents[] = ['text' => zen_draw_label(TEXT_MANUFACTURERS_NAME, 'manufacturers_name', 'class="control-label"') . zen_draw_input_field('manufacturers_name', htmlspecialchars((string) $mInfo->manufacturers_name, ENT_COMPAT, CHARSET, true), zen_set_field_length(TABLE_MANUFACTURERS, 'manufacturers_name') . ' class="form-control" id="manufacturers_name" required')];
        ...
        $contents[] = ['text' => zen_draw_label(TEXT_MANUFACTURERS_IMAGE, 'manufacturers_image', 'class="control-label"') . zen_draw_file_field('manufacturers_image', '') . '<br>' . $mInfo->manufacturers_image];
        $dir_info = zen_build_subdirectories_array(DIR_FS_CATALOG_IMAGES);
    ...
    case 'delete':
        ...
        $contents = ['form' => zen_draw_form('manufacturers', FILENAME_MANUFACTURERS, ($currentPage != 0 ? 'page=' . $currentPage . '&' : '') . 'action=deleteconfirm', 'post') . zen_draw_hidden_field('mID', $mInfo->manufacturers_id)];
...
?>
      ...
      <div class="row">
        <table class="table">
          <tr>
            <td><?php echo $manufacturers_split->display_count($manufacturers_query_numrows); ?></td>
