...
class sfYamlParser
{
     ...
     */
    protected function getRealCurrentLineNb(): float|int|array
    {
     ...
     */
    protected function getNextEmbedBlock($indentation = null): string
    {
        $this->moveToNextLine();
     ...
     */
    protected function parseFoldedScalar($separator, $indicator = '', $indentation = 0): string|array|null
    {
        $separator = '|' == $separator ? "\n" : ' ';
        $text = '';
     ...
     */
    protected function cleanup($value): string|array|null
    {
        $value = str_replace(["\r\n", "\r"], "\n", $value);
