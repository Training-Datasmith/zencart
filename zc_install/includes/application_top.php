 ...
 */
$request_type = ((isset($_SERVER['HTTPS']) && (strtolower((string) $_SERVER['HTTPS']) == 'on' || $_SERVER['HTTPS'] == '1')) ||
    (isset($_SERVER['HTTP_X_FORWARDED_BY']) && stripos((string) $_SERVER['HTTP_X_FORWARDED_BY'], 'SSL') !== false) ||
    (isset($_SERVER['HTTP_X_FORWARDED_HOST']) && (stripos((string) $_SERVER['HTTP_X_FORWARDED_HOST'], 'SSL') !== false)) ||
...
$current_page = preg_replace('/[^a-z0-9_]/', '', (string) $_GET['main_page']);
...
$lng_short = substr((string) $installer_lng, 0, strpos((string) $installer_lng, '_'));
