...
?>
    <fieldset class="border rounded p-3 mt-2">
        <legend><?php 
<?= TEXT_ADMIN_SETUP_USER_SETTINGS ?>
?></legend>
        <div class="row mb-2">
...
?>
            ...
            <div class="col-6 col-md-5 col-lg-4">
                <input class="form-control" type="text" name="admin_user" id="admin_user" value="" tabindex="1" autofocus="autofocus" placeholder="<?php 
<?= TEXT_EXAMPLE_USERNAME ?>
...
?>
            ...
            <div class="col-6 col-md-5 col-lg-4">
                <input class="form-control" type="email" name="admin_email" id="admin_email" value="" tabindex="2" placeholder="<?php 
<?= TEXT_EXAMPLE_EMAIL ?>
?>" required autocomplete="off">
...
?>
            ...
            <div class="col-6 col-md-5 col-lg-4">
                <input class="form-control" type="email" name="admin_email2" id="admin_email2" value="" tabindex="3" placeholder="<?php 
<?= TEXT_EXAMPLE_EMAIL ?>
?>" required data-equalto="admin_email" autocomplete="off">
                <div class="invalid-feedback"><?php 
?></div>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col alert alert-danger"><?php 
<?= TEXT_ADMIN_SETUP_USER_PASSWORD_HELP ?>
?></div>
        </div>
        <div class="row mb-2">
            <div class="col-5 col-sm-6 col-md-4 col-lg-3">
...
?>
            ...
            <div class="col-6 col-md-5 col-lg-4">
                <input class="form-control" type="text" name="admin_password" id="admin_password" value="<?php 
<?= $admin_password ?>
?>" readonly="readonly" tabindex="4" autocomplete="off">
            </div>
        </div>
        <div class="row mb-2">
            <?php 
...
?>
            ...
            <div class="col-6 col-md-5 col-lg-4">
                <input class="form-control" type="text" name="admin_directory" id="admin_directory" value="<?php 
<?= $adminNewDir ?>
?>" readonly="readonly" tabindex="5" autocomplete="off">
            </div>
        </div>
    </fieldset>
    <input class="btn btn-primary mt-3" type="submit" id="btnsubmit" name="btnsubmit" value="<?php 
<?= TEXT_CONTINUE ?>
?>" tabindex="10">
</form>
